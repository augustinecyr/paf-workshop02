package com.sg.app.pafworkshopd2.repositories;
...
import com.sg.app.pafworkshopd2.models.RSVPTotalCntMapper;

import static com.sg.app.pafworkshopd2.repositories.Queries.*;
...
public class RSVPRepository {
    ...
    public List<RSVP> getAllRSVP(String q) {
        ...
        SqlRowSet rs = null;
        // perform the query
        System.out.println("Query parameter is " + q);
        if (q == null) {
